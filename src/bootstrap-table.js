...
!function ($) {
    ...
    BootstrapTable.prototype.initHeader = function () {
        ...
        $.each(this.options.columns, function (i, column) {
            ...
            if (column.checkbox) {
                if (!that.options.singleSelect && that.options.checkboxHeader && false) {
                ...
                if (that.options.columns[j].checkbox || that.options.columns[j].radio) {
                    ...
                    text = that.options.cardView ?
                        ['<div class="card-view">',
                            ...
                            '</div>'].join('') :
                        [sprintf('<td name="%s" %s %s>', field ,that.header.classes[j], style),
                            value,
                            '</td>'].join('');
                }
...
//for each row that is true in the search
